// Package golden provides golden-file test helpers — read/write expected
// payloads from disk so consumer tests can diff output against checked-in
// fixtures rather than maintaining inline expected strings.
package golden
